...
|---|---|
| <img src="images/screen2.jpg" width="480" alt="Box view: the 5x4 grid with the selected Pokemon's sprite and stats"/> | <img src="images/screen1.jpg" width="480" alt="Deposit mode: the party row under the box grid"/> |
